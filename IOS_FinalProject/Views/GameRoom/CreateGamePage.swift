                ...
                VStack{
                    ...
                    HStack{
                        ...
                        Button(action: {
                            ...
                            let newgame = GameData(roomNameString: GameDataComponent.roomNameString, gamestart: false, chessboard: boards, flag: 0, whoWin: -1, finish: false, player1: newUser1, player2: newUser2)
